...
class VideoStreamingTest:
    def __init__(self):
        ...
        self.server_socket.bind(video_stream_address)
    ...
    def stream_video(self):
        ...
        try:
            ...
            while True:
                ...
                # Show the frame
                cv2.imshow('Video', cv2.resize(image, dim, interpolation = cv2.INTER_AREA))
                # cv2.imshow('Video', cv2.rotate(image, cv2.ROTATE_180))
